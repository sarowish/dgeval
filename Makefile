CXX = g++
SRC = main.cpp driver.cpp parser.cpp scanner.cpp printer.cpp dependency.cpp checker.cpp fold.cpp
OBJ = ${SRC:.cpp=.o}
...
main.o: main.cpp checker.hpp context.hpp ast.hpp location.hpp visitor.hpp \
  dependency.hpp driver.hpp parser.hpp printer.hpp fold.hpp
